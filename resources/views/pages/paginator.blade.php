    ...
    <nav aria-label="...">
        <ul class="pagination">
            @if($table->currentPage() != 1)
                <li class="page-item">
                    <a class="page-link" href="/{{ $page . $table->previousPageUrl() }}">Previous</a>
                </li>
            ...
            @if($table->currentPage() != $table->lastPage())
                <li class="page-item">
                    <a class="page-link" href="/{{ $page . $table->nextPageUrl() }}">{{ $table->currentPage() + 1 }}</a>
                </li>
                ...
                <li class="page-item">
                    <a class="page-link"
                       href="/{{ $page . $table->nextPageUrl() }}">Next</a>
                </li>
            @endif
        </ul>
    </nav>
